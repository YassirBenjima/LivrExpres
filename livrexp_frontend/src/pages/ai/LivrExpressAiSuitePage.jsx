...
export default function LivrExpressAiSuitePage({ navigate, showNotification, defaultTab = 'predictions', activeMenu = 'ai_predictions' }) {
  ...
  // AI Predictions State with rich sample dataset including High (Élevé), Medium (Moyen), and Low (Faible) risk tiers
  const [predictions, setPredictions] = useState([
    {
      colis_id: 101,
      tracking_code: 'CMD-9801',
      destinataire: 'Amine El Amrani',
      ville: 'Oujda',
      crbt: 1450.00,
      prediction: {
        risk_score: 88,
        ...
        factors: [
          ...
          "Montant CRBT élevé (1450.00 DH): Risque de refus (+25%)",
          "Historique d'annulations client répétées sur ce secteur (+38%)"
        ],
        recommendation: "Recommandé : Effectuer un appel de pré-confirmation téléphonique auprès de Amine El Amrani avant départ."
      }
    },
    {
      colis_id: 102,
      tracking_code: 'CMD-9802',
      destinataire: 'Fatima Zohra Mansouri',
      ville: 'Tanger',
      crbt: 890.00,
      prediction: {
        risk_score: 76,
        ...
        badge_color: 'destructive',
        factors: [
          "Numéro de téléphone suspect ou absent (+30%)",
          "Montant CRBT modéré (890.00 DH) (+12%)",
          "Ville à risque modéré (Tanger: +15%)"
        ],
        recommendation: "Recommandé : Confirmer l'adresse exacte et l'horaire de présence avant chargement."
      }
    },
    {
      colis_id: 103,
      tracking_code: 'CMD-9803',
      destinataire: 'Youssef Benali',
      ville: 'Fès',
      crbt: 620.00,
      prediction: {
        risk_score: 45,
        ...
        badge_color: 'warning',
        factors: [
          "Montant CRBT modéré (620.00 DH) (+12%)",
          "Taux de livrabilité standard pour Fès"
        ],
        recommendation: "Envoyer une notification WhatsApp de confirmation d'adresse à Youssef Benali."
      }
    },
    {
      colis_id: 104,
      tracking_code: 'CMD-9804',
      destinataire: 'Karim Tazi',
      ville: 'Casablanca',
      crbt: 250.00,
      prediction: {
        risk_score: 10,
        ...
        badge_color: 'success',
        factors: [
          "Montant CRBT standard (250.00 DH)",
          "Taux de livrabilité excellent pour Casablanca"
        ],
  ...
  // AI Anomalies State covering all 3 anomaly types (Retard Ramassage, Inactivité prolongée, Problème Livraison)
  const [anomalies, setAnomalies] = useState([
    {
      colis_id: 201,
      tracking_code: 'CMD-7701',
      destinataire: 'Brahim Naciri',
      ville: 'Marrakech',
      etat: 'En attente',
      hours_stuck: 34.5,
      severity: 'WARNING',
      ...
      description: 'Colis en attente de ramassage depuis 34.5h (Seuil recommandé: 24h).',
      action_suggested: 'Ré-assigner d\'urgence un livreur pour ramasser la commande de Brahim Naciri.'
    },
    {
      colis_id: 202,
      tracking_code: 'CMD-7702',
      destinataire: 'Siham Berada',
      ville: 'Agadir',
      etat: 'Expédié',
      hours_stuck: 52.0,
      severity: 'CRITICAL',
      ...
      description: 'Aucune mise à jour de statut de livraison depuis 52 heures à Agadir.',
      action_suggested: 'Ouvrir un ticket d\'enquête auprès du hub logistique d\'Agadir (Siham Berada).'
    },
    {
      colis_id: 203,
      tracking_code: 'CMD-7703',
      destinataire: 'Rachid Chraibi',
      ville: 'Rabat',
      etat: 'En cours',
      hours_stuck: 41.8,
      severity: 'CRITICAL',
      ...
      action_suggested: 'Déclencher un appel de confirmation et mettre à jour le créneau (Rachid Chraibi).'
    }
  ]);
