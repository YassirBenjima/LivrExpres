                        ...
                        <tr>
                          ...
                          <td className="py-2">
                            <div className="flex justify-center items-center">
                              <div className="kt-image-input size-16 relative" style={{ display: 'inline-block' }}>
                                <input 
                                  ref={fileInputRef}
                                  accept=".png, .jpg, .jpeg" 
                                  type="file" 
                                ...
                                {photo && (
                                  <button 
                                    className="absolute -top-1.5 -right-1.5 size-5 bg-background border border-border rounded-full flex items-center justify-center hover:bg-muted shadow z-20"
                                    onClick={handleRemovePhoto}
                                    type="button"
                                  >
                                    <i className="ki-filled ki-cross text-[10px] text-muted-foreground"></i>
                                  </button>
                                )}
                                <div className="kt-image-input-placeholder border border-input rounded-full overflow-hidden w-full h-full relative">
                                  <div 
                                    className="w-full h-full bg-cover bg-center" 
                                    style={{ backgroundImage: `url('${photoPreview}')` }}
                                  />
                                  <div className="flex items-center justify-center h-5 left-0 right-0 bottom-0 bg-black/25 absolute pointer-events-none">
                                    <svg className="fill-border opacity-80" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg">
