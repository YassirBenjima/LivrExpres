          ...
          <div className="kt-container-fixed flex justify-between items-stretch lg:gap-4 w-full" id="headerContainer">
            ...
            <div className="flex items-center gap-3">
              ...
              <div ref={userMenuRef} className="relative shrink-0">
                ...
                {isUserMenuOpen && (
                  <MenuErrorBoundary>
                    {/* Explicitly Rounded Dropdown Panel */}
                    <div
                      className="absolute end-0 top-full mt-2.5 w-[320px] shadow-2xl bg-white dark:bg-zinc-900 border-2 border-white dark:border-zinc-700 ring-1 ring-black/10 dark:ring-white/10 z-[100] opacity-100 animate-in fade-in slide-in-from-top-1 duration-150"
                      style={{ borderRadius: '24px', overflow: 'hidden', border: themeMode === 'dark' ? '2px solid #3f3f46' : '2px solid #ffffff' }}
                    >
                      
                      {/* User Header Info Card */}
                      <div className="p-3.5 bg-zinc-50/90 dark:bg-zinc-800/80 border-b border-zinc-200/90 dark:border-zinc-700/90 flex items-center justify-between gap-3" style={{ borderTopLeftRadius: '22px', borderTopRightRadius: '22px' }}>
