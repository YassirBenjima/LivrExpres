                  ...
                  <MenuErrorBoundary>
                    ...
                    >
                      ...
                      <div className="p-1.5 space-y-1 bg-white dark:bg-[#18181b]">
                        ...
                        <div className="flex items-center justify-between w-full px-3 py-1.5 text-xs font-semibold text-foreground">
                          ...
                          >
                            {langOptions.map(({ code, label, flag }) => (
                              <button
                                ...
                                className={`flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-bold rounded-lg transition-all ${
                                  language === code
                                    ? 'bg-white dark:bg-zinc-800 text-primary shadow-xs border border-zinc-200/80 dark:border-zinc-700/80'
                                    : 'text-muted-foreground hover:text-foreground opacity-75 hover:opacity-100'
                                }`}
                                title={label}
                              >
                                <img alt="" className="size-3.5 rounded-full object-cover shrink-0" src={flag} />
